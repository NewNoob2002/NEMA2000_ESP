...
#ifndef __SEMP_CRC_SBF_H__
#define __SEMP_CRC_SBF_H__

#include <semp_config.h>

#if defined(SEMP_CRC_SBF_CONFIG_ON)
...
static const uint16_t semp_ccitt_crc_table[256] = {
...
static uint16_t
semp_ccitt_crc_update(uint16_t crc, const uint8_t data) {
