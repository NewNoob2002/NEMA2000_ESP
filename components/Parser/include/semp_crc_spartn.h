...
#ifndef __SEMP_CRC_SPARTN_H__
#define __SEMP_CRC_SPARTN_H__

#include <semp_config.h>

#if defined(SEMP_CRC_SPARTN_CONFIG_ON)
...
const uint8_t semp_u8Crc4Table[] = {
    0x00U, 0x0BU, 0x05U, 0x0EU, 0x0AU, 0x01U, 0x0FU, 0x04U, 0x07U, 0x0CU, 0x02U, 0x09U, 0x0DU, 0x06U, 0x08U, 0x03U,
    0x0EU, 0x05U, 0x0BU, 0x00U, 0x04U, 0x0FU, 0x01U, 0x0AU, 0x09U, 0x02U, 0x0CU, 0x07U, 0x03U, 0x08U, 0x06U, 0x0DU,
    0x0FU, 0x04U, 0x0AU, 0x01U, 0x05U, 0x0EU, 0x00U, 0x0BU, 0x08U, 0x03U, 0x0DU, 0x06U, 0x02U, 0x09U, 0x07U, 0x0CU,
    0x01U, 0x0AU, 0x04U, 0x0FU, 0x0BU, 0x00U, 0x0EU, 0x05U, 0x06U, 0x0DU, 0x03U, 0x08U, 0x0CU, 0x07U, 0x09U, 0x02U,
    0x0DU, 0x06U, 0x08U, 0x03U, 0x07U, 0x0CU, 0x02U, 0x09U, 0x0AU, 0x01U, 0x0FU, 0x04U, 0x00U, 0x0BU, 0x05U, 0x0EU,
    0x03U, 0x08U, 0x06U, 0x0DU, 0x09U, 0x02U, 0x0CU, 0x07U, 0x04U, 0x0FU, 0x01U, 0x0AU, 0x0EU, 0x05U, 0x0BU, 0x00U,
    0x02U, 0x09U, 0x07U, 0x0CU, 0x08U, 0x03U, 0x0DU, 0x06U, 0x05U, 0x0EU, 0x00U, 0x0BU, 0x0FU, 0x04U, 0x0AU, 0x01U,
    0x0CU, 0x07U, 0x09U, 0x02U, 0x06U, 0x0DU, 0x03U, 0x08U, 0x0BU, 0x00U, 0x0EU, 0x05U, 0x01U, 0x0AU, 0x04U, 0x0FU,
    0x09U, 0x02U, 0x0CU, 0x07U, 0x03U, 0x08U, 0x06U, 0x0DU, 0x0EU, 0x05U, 0x0BU, 0x00U, 0x04U, 0x0FU, 0x01U, 0x0AU,
    0x07U, 0x0CU, 0x02U, 0x09U, 0x0DU, 0x06U, 0x08U, 0x03U, 0x00U, 0x0BU, 0x05U, 0x0EU, 0x0AU, 0x01U, 0x0FU, 0x04U,
    0x06U, 0x0DU, 0x03U, 0x08U, 0x0CU, 0x07U, 0x09U, 0x02U, 0x01U, 0x0AU, 0x04U, 0x0FU, 0x0BU, 0x00U, 0x0EU, 0x05U,
    0x08U, 0x03U, 0x0DU, 0x06U, 0x02U, 0x09U, 0x07U, 0x0CU, 0x0FU, 0x04U, 0x0AU, 0x01U, 0x05U, 0x0EU, 0x00U, 0x0BU,
    0x04U, 0x0FU, 0x01U, 0x0AU, 0x0EU, 0x05U, 0x0BU, 0x00U, 0x03U, 0x08U, 0x06U, 0x0DU, 0x09U, 0x02U, 0x0CU, 0x07U,
    0x0AU, 0x01U, 0x0FU, 0x04U, 0x00U, 0x0BU, 0x05U, 0x0EU, 0x0DU, 0x06U, 0x08U, 0x03U, 0x07U, 0x0CU, 0x02U, 0x09U,
    0x0BU, 0x00U, 0x0EU, 0x05U, 0x01U, 0x0AU, 0x04U, 0x0FU, 0x0CU, 0x07U, 0x09U, 0x02U, 0x06U, 0x0DU, 0x03U, 0x08U,
    0x05U, 0x0EU, 0x00U, 0x0BU, 0x0FU, 0x04U, 0x0AU, 0x01U, 0x02U, 0x09U, 0x07U, 0x0CU, 0x08U, 0x03U, 0x0DU, 0x06U};

    0x00D1C4EFU, 0x00DD5D19U, 0x005B11E2U, 0x00C46EF5U, 0x0042220EU, 0x004EBBF8U, 0x00C8F703U, 0x003F964DU, 0x00B9DAB6U,
    0x00B54340U, 0x00330FBBU, 0x00AC70ACU, 0x002A3C57U, 0x0026A5A1U, 0x00A0E95AU, 0x009E1774U, 0x00185B8FU, 0x0014C279U,
    0x00928E82U, 0x000DF195U, 0x008BBD6EU, 0x00872498U, 0x00016863U, 0x00FAD8C4U, 0x007C943FU, 0x00700DC9U, 0x00F64132U,
    0x00693E25U, 0x00EF72DEU, 0x00E3EB28U, 0x0065A7D3U, 0x005B59FDU, 0x00DD1506U, 0x00D18CF0U, 0x0057C00BU, 0x00C8BF1CU,
    0x004EF3E7U, 0x00426A11U, 0x00C426EAU, 0x002AE476U, 0x00ACA88DU, 0x00A0317BU, 0x00267D80U, 0x00B90297U, 0x003F4E6CU,
    0x0033D79AU, 0x00B59B61U, 0x008B654FU, 0x000D29B4U, 0x0001B042U, 0x0087FCB9U, 0x001883AEU, 0x009ECF55U, 0x009256A3U,
    0x00141A58U, 0x00EFAAFFU, 0x0069E604U, 0x00657FF2U, 0x00E33309U, 0x007C4C1EU, 0x00FA00E5U, 0x00F69913U, 0x0070D5E8U,
    0x004E2BC6U, 0x00C8673DU, 0x00C4FECBU, 0x0042B230U, 0x00DDCD27U, 0x005B81DCU, 0x0057182AU, 0x00D154D1U, 0x0026359FU,
    0x00A07964U, 0x00ACE092U, 0x002AAC69U, 0x00B5D37EU, 0x00339F85U, 0x003F0673U, 0x00B94A88U, 0x0087B4A6U, 0x0001F85DU,
    0x000D61ABU, 0x008B2D50U, 0x00145247U, 0x00921EBCU, 0x009E874AU, 0x0018CBB1U, 0x00E37B16U, 0x006537EDU, 0x0069AE1BU,
    0x00EFE2E0U, 0x00709DF7U, 0x00F6D10CU, 0x00FA48FAU, 0x007C0401U, 0x0042FA2FU, 0x00C4B6D4U, 0x00C82F22U, 0x004E63D9U,
    0x00D11CCEU, 0x00575035U, 0x005BC9C3U, 0x00DD8538U};

const uint32_t semp_u32Crc32Table[] = {
...
semp_uSpartnCrc4(const uint8_t* pU8Msg, int size) {
    ...
    for (int x = 0; x < size; x++) {
        ...
        u8Remainder = semp_u8Crc4Table[u8TableRemainder];
    }
...
static inline uint8_t
semp_uSpartnCrc8(const uint8_t* pU8Msg, int size) {
    // Initialize local variables
    uint8_t u8TableRemainder;
    uint8_t u8Remainder = 0; // Initial remainder
    ...
    for (int x = 0; x < size; x++) {
        u8TableRemainder = pU8Msg[x] ^ u8Remainder;
        u8Remainder = semp_u8Crc8Table[u8TableRemainder];
    }
...
semp_uSpartnCrc16(const uint8_t* pU8Msg, int size) {
    // Initialize local variables
    ...
    for (int x = 0; x < size; x++) {
        ...
        u16Remainder = semp_u16Crc16Table[u16TableRemainder] ^ (u16Remainder << 8);
    }
...
semp_uSpartnCrc24(const uint8_t* pU8Msg, int size) {
    // Initialize local variables
    ...
    for (int x = 0; x < size; x++) {
        ...
        u32Remainder = semp_u32Crc24Table[u32TableRemainder] ^ (u32Remainder << 8);
...
static inline uint32_t
semp_uSpartnCrc32(const uint8_t* pU8Msg, int size) {
    // Initialize local variables
    uint32_t u32TableRemainder;
    ...
    for (int x = 0; x < size; x++) {
        u32TableRemainder = pU8Msg[x] ^ (u32Remainder >> (u8NumBitsInCrc - 8));
        u32Remainder = semp_u32Crc32Table[u32TableRemainder] ^ (u32Remainder << 8);
    }
